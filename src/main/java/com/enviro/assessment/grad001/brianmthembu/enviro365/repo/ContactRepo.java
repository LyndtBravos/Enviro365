...
public class ContactRepo
{
	...
	public ResponseEntity<?> insert(Contact contact) {
		...
		return stringReturned.contains("failed") ? new ResponseEntity<>(stringReturned, HttpStatus.BAD_REQUEST) : new ResponseEntity<>(stringReturned, HttpStatus.ACCEPTED);
	}
